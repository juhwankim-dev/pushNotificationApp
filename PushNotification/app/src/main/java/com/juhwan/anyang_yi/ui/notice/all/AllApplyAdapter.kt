...
import com.juhwan.anyang_yi.databinding.ItemAllApplyBinding
import com.juhwan.anyang_yi.ui.notice.WebViewActivity

class AllApplyAdapter : RecyclerView.Adapter<AllApplyAdapter.AllApplyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AllApplyViewHolder {
        ...
        val binding = ItemAllApplyBinding.inflate(layoutInflater, parent, false)
    ...
    inner class AllApplyViewHolder(private val binding: ItemAllApplyBinding) :
